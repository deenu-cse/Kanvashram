...
const RetroDvdTv = () => {
  ...
  const historicalChapters = [
    ...
    },
    {
      ...
      image: "history.jpg",
      content: "It was only in the 18th century that the British came to this region with an intention to hunt, seeing the abundant availability of wild life. Jim Corbett also came as a hunter to this region but dedicated his life in protecting the people of Garhwal & Kumaon region from the ferocious man eaters. The area became a domain of dacoit. It was only after their eradication that people begin to settle in this region and Kanvashram once again emerged on the map of this mighty nation Bharat."
    }
  ];
      ...
      <div className=" py-8 md:flex md:space-x-4 relative">
        ...
        <div className="md:w-1/4 mb-4 md:mb-0">
          <div className="hero-header text-center md:text-left mb-6">
            <h1 className="text-3xl md:text-4xl font-bold text-[#88734C] font-serif">कण्वाश्रम</h1>
